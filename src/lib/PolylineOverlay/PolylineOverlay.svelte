<script>
  ...
  function addPolylineOverlay() {
    if (map && mapkitGlobal) {
      const points = [ [41, -109.05], [41, -102.05] ];
...
<div popover id="polyline-overlay-popover" class="popover">
  ...
  <div class="button-row">
    ...
    <button class="custom-btn" onclick={polylineOverlayAdded ? removeCustomPolylineOverlay : addPolylineOverlay}>Toggle Custom Overlay</button>
  </div>
</div>
